          ...
          children: [
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: _isFutureAppointment ? Colors.grey : theme.colorScheme.primary,
              ...
              child: _saving
                  ...
                  : Text(
                      _isFutureAppointment ? "Cannot Submit (Future Appointment)" : t.saveReport,
        ...
        Align(
          ...
          child: TextButton.icon(
            ...
            icon: Icon(
              ...
              color: _isFutureAppointment ? Colors.grey : theme.colorScheme.primary,
            ),
            label: Text(
              t.addMedicine,
              style: TextStyle(
