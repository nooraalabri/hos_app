          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                AppInput(
                  controller: _name,
                  label: AppLocalizations.of(context)?.fullname ?? 'My Name',
                  validator: (v) =>
                ...
                GestureDetector(
                  ...
                  child: AbsorbPointer(
                    child: AppInput(
                      controller: _dob,
                      label: AppLocalizations.of(context)?.date_of_birth ?? 'Date of Birth',
                      hint: 'YYYY-MM-DD',
                      validator: (v) =>
                      (v == null || v.isEmpty) ? 'Required' : null,
                    ),
                ...
                AppInput(
                  controller: _civil,
                  label: AppLocalizations.of(context)?.civil_number ?? 'Civil Number',
                ...
                PasswordInput(
                  controller: _pass2,
                  label: AppLocalizations.of(context)?.confirm_password ?? 'Confirm Password',
                  validator: (v) {
                    if (v == null || v.isEmpty) {
                ...
                Center(
                  child: Wrap(
                    ...
                    children: [
                      Text('${AppLocalizations.of(context)?.welcome_back ?? 'Already have an account'}? '),
                      InkWell(
