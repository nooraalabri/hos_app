...
import 'package:hos_app/screens/chatbot_screen.dart';
...
class AppRoutes {
  ...
  static Map<String, WidgetBuilder> map = {
    // Auth
    // Note: welcome route ('/') is removed because we use home: AuthWrapper() in main.dart
    ...
    patientInvoices: (_) => const PatientInvoicesScreen(),
    chatbot: (_) => const ChatbotScreen(),
    socialMedia: (_) => const SocialMediaPostScreen(),
