                        ...
                        children: [
                          TextButton.icon(
                            onPressed: () async {
                              ...
                              // Also update in root appointments collection
                              ...
                              final formattedDate = DateFormat('yyyy-MM-dd').format(
                                (apptData['time'] as Timestamp).toDate()
                              );
                              ...
                              await NotificationService.sendFCMNotification(
                                ...
                                body: 'Patient ${apptData['patientName']} cancelled their appointment on $formattedDate.',
                                data: {
                              ...
                              // Doctor notification in Firestore
                              ...
                              // Patient FCM notification
                              if (currentUser != null) {
                                await NotificationService.sendFCMNotification(
                                  userId: currentUser.uid,
                                  title: 'Appointment Cancelled',
                                  body: 'Your appointment with Dr. ${apptData['doctorName']} on $formattedDate has been cancelled.',
                                  data: {
                                    'type': 'appointment_cancelled',
                                    'appointmentId': docRef.id,
                                ...
                                // Patient notification in Firestore
                                await fs.collection('notifications').add({
                                  'userId': currentUser.uid,
                                  'toRole': 'patient',
                                  'title': 'Appointment Cancelled',
